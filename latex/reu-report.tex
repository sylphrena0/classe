...
\section{Introduction}%!!!look into top features and what they are, add to paper and presentation
...
\section{Methodology} %!!!fix double figure page (move 5th page)
\subsection{Database} %!!!fix figure numbers including section numbers!!
...
\subsection{Machine Learning} %!!!add discussion of linear regression
