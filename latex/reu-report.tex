...
\end{figure*}
 ...
 \begin{figure*}[!b] %star makes figure and caption span both columns
   ...
   %  \includegraphics[height=2.23in]{images/subfigures/uncertainty/linear_regression.png}
    ...
    \caption{Graph of optimized model predictions versus actual critical temperatures for selected base model with confidence intervals.}
