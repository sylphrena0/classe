...
\subsection{Project Structure} %spell out CLASSE, link/cite CLASSE - move data/code availabilty to it's own subsection
...
\subsection{Optimized Models}\label{sec:optimized-models} %explcity say which is best model
...
\subsection{Feature Selection} %abbriviate feature names for correlation plot, maybe use feature importance table
